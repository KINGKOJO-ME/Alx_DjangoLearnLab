...
# UserProfile model to extend Django's built-in User model with a role field
...
class CustomUserManager(BaseUserManager):
    ...
    def create_superuser(self, username, email, date_of_birth=None, password=None, **extra_fields):
        ...
        return self.create_user(username, email, date_of_birth, None, password, **extra_fields)
