...
# ------------------------------------------------------------
# When Django is behind a proxy (like Nginx), the proxy handles HTTPS.
# This setting tells Django to trust the X-Forwarded-Proto header sent
# by the proxy to determine if the original request was HTTPS.
